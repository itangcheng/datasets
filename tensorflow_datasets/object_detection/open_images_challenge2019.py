...
_TRAIN_IMAGES_URLS = [
    _FIGURE_EIGHT_BASE_URL + "zip_files_copy/train_00.zip",
    _FIGURE_EIGHT_BASE_URL + "zip_files_copy/train_01.zip",
    _FIGURE_EIGHT_BASE_URL + "zip_files_copy/train_02.zip",
    _FIGURE_EIGHT_BASE_URL + "zip_files_copy/train_03.zip",
    _FIGURE_EIGHT_BASE_URL + "zip_files_copy/train_04.zip",
    _FIGURE_EIGHT_BASE_URL + "zip_files_copy/train_05.zip",
    _FIGURE_EIGHT_BASE_URL + "zip_files_copy/train_06.zip",
    _FIGURE_EIGHT_BASE_URL + "zip_files_copy/train_07.zip",
    _FIGURE_EIGHT_BASE_URL + "zip_files_copy/train_08.zip",
]
...
class _OpenImagesChallenge2019(tfds.core.BeamBasedBuilder):
  ...
  def annotation_urls(self):
    """Dictionary with the urls to download containing the annotations."""
...
class OpenImagesChallenge2019Detection(_OpenImagesChallenge2019):
  ...
  def __init__(self, _num_classes=500, **kwargs):  # pylint: disable=invalid-name
    # Note: `_num_classes` should only be manually set by tests.
    self._num_classes = _num_classes
    super(OpenImagesChallenge2019Detection, self).__init__(**kwargs)
