...
class _TestableOpenImagesChallenge2019Detection(
    open_images_challenge2019.OpenImagesChallenge2019Detection):

  def __init__(self, **kwargs):
    super(_TestableOpenImagesChallenge2019Detection, self).__init__(
        _num_classes=6, **kwargs)


class OpenImagesChallenge2019DetectionTest(testing.DatasetBuilderTestCase):
  DATASET_CLASS = _TestableOpenImagesChallenge2019Detection
